...
},{}],"utilities/construct-verticals.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.constructVerticals = void 0;

var _monthIterator = require("./monthIterator");
...
const constructForYearVertical = (mainSvg, nthMonthOfYear) => {
  let monthCounter = 0;
  let mIter = (0, _monthIterator.monthIterator)();
...
const constructVerticals = (chartType, mainSvg, nthMonthOfYear) => {
  if (chartType === "year") {
...
exports.constructVerticals = constructVerticals;
},{"./monthIterator":"utilities/monthIterator.js"}],"utilities/construct-horizontals.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.constructHorizontals = void 0;

const constructHorizontals = (chartType, mainSvg, nthDayOfYear) => {
  constructHorizontalsMonth(mainSvg, nthDayOfYear);
};

exports.constructHorizontals = constructHorizontals;

const constructHorizontalsMonth = (mainSvg, nthDayOfYear) => {
  const middleLineStart = mainSvg.append("g").attr("id", `middle-line-start`);
  middleLineStart.append("line").classed("cls-3", true).attr("y1", 120).attr("y2", 120).attr("x2", 62);
  let monthCounter = 0;
...
var _constructVerticals = require("./utilities/construct-verticals");

var _constructHorizontals = require("./utilities/construct-horizontals");

function _getRequireWildcardCache() { if (typeof WeakMap !== "function") return null; var cache = new WeakMap(); _getRequireWildcardCache = function () { return cache; }; return cache; }

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }

const lineOne = document.getElementById(`line-1`).firstElementChild; // lineOne.style.stroke = "red";
// console.log(lineOne);
